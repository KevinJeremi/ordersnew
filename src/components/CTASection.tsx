...
export default function CTASection() {
    return (
        <section className="py-16 bg-gradient-to-r from-[#061E44] to-[#3D8C95]">
            <div className="container mx-auto px-4 text-center">
                <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
                    Siap Wujudkan Proyek Impian Anda?
                </h2>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                    ...
                    <Link
                        href="/pricing"
                        className="inline-flex items-center px-8 py-4 bg-white/10 border-2 border-white/20 text-white hover:bg-white/20 font-semibold rounded-lg transition-all duration-300 backdrop-blur-sm"
                    >
                        Lihat Paket Harga
                    </Link>
                </div>
