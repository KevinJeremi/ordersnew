...
export default function PricingPage() {
    ...
    const toggleFAQ = (index: number) => {
        ...
        <>
            ...
            {/* Main Content */}            <main className="pt-20">
                {/* Hero Section */}
                    ...
                    <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                            ...
                            <div className="order-1 lg:order-2 text-center lg:text-left">
                                <div className="mb-6">
                                    <span className="inline-flex items-center px-4 py-2 bg-[#FF7A00]/10 text-[#FF7A00] rounded-full text-sm font-medium mb-4">
                                        <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1" />
                                        </svg>
                                        Pricing Plans
                                    </span>
                                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-[#061E44] mb-6 leading-tight">
                                        Paket
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                                    <div className="flex items-center space-x-3 bg-white/80 backdrop-blur-sm rounded-lg p-3 shadow-sm">
                                        <div className="w-8 h-8 bg-green-100 rounded-full flex items-center justify-center">
                                            <svg className="w-4 h-4 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                                            </svg>
                                        </div>
                                        <span className="text-sm font-medium text-gray-700">Konsultasi Gratis</span>
                                    </div>
                                    <div className="flex items-center space-x-3 bg-white/80 backdrop-blur-sm rounded-lg p-3 shadow-sm">
                                        ...
                                        <span className="text-sm font-medium text-gray-700">Support Penuh</span>
                                    </div>
                                    <div className="flex items-center space-x-3 bg-white/80 backdrop-blur-sm rounded-lg p-3 shadow-sm">
                                        ...
                                        <span className="text-sm font-medium text-gray-700">Setup Cepat</span>
                                    </div>
                                    <div className="flex items-center space-x-3 bg-white/80 backdrop-blur-sm rounded-lg p-3 shadow-sm">
                                ...
                                <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                                    ...
                                    <a
                                        ...
                                        className="inline-flex items-center justify-center px-8 py-4 bg-white border-2 border-[#061E44] text-[#061E44] hover:bg-[#061E44] hover:text-white font-semibold rounded-xl transition-all duration-300"
                                    >
